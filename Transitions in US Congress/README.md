...
- Outputs
  1. Interactivity Feature #1 | 
  2. Interactivity Feature #2 |
...
This file is a cutom built dataset which contains the number of seats each state represents i the US house of Representatives for different decades based on the census.

- "Data Collection House  - 2014 - 2020.csv"
This is a custom built dataset that contains the data about the US House of Representatives for the years 2014 through 2020. This data includes the election year, state, distrcit number, winning candidates name & winning candidates party.
...
I have uploaded the all datasets in the data directory and you can find it here [data/]().
